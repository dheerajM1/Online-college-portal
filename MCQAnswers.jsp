...
MCQ questions = (MCQ) session.getAttribute("questions");
            ...
            <div id="content">
                <div class="post">
                    ...
                    <div class="entry"><br><br>
                                <form action="MCQQuestionAnswerAction" method="get" >
                                    <center>
                                        ...
                                        <br><br><br>
                                                    <table>
                                                     ...
                                                     <input type="hidden"  name="checkAnswer" value="check"/>
                                                       <input type="hidden"  name="mcqiD" value="<%=questions.getMcqID() %>"/>
                                                     <tr>
