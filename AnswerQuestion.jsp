					...
					<br> <br>
						...
						<center>
							...
							<div style="display: flex">
								<a href="${pageContext.request.contextPath}/MCQQuestionAnswerAction">
									<div style="flex: 1; padding-right: 5px;">
										<img src="images/MCQ.jpg"  width="80%"  height="40%">
									</div><strong>Multiple Choices Questions</strong></a> <a href="${pageContext.request.contextPath}/NumaricQuestionAnswerAction"> <div style="flex: 1; padding-left: 5px;">
