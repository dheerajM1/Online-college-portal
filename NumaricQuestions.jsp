            ...
            <div id="content">
                <div class="post">
                    ...
                    <div class="entry"><br><br>
                                <form action="NumaricAction" method="post" id="queryform">
                                    <center>
                                                    ...
                                                    <table>
                                                     <tr>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td> <textarea rows="3" cols="50" align="left" name="answer"> </textarea></td>
                                                        </tr>
                                                        <tr></tr> <tr></tr> <tr></tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <input type="submit" value="Iamdone" name="Iamdone" style="height: 25px;width: 160px;"/>
                                                            </td>
                                                        </tr>
